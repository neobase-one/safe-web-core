...
/*
// old one
const chains: Chains = networks.reduce<Chains>((result, { shortName, chainId }) => {
  result[shortName] = chainId.toString()
  return result
}, {})
// new one (use this one)
...
const ChainLogos = {
  ...
  [chains.canto]: '/images/networks/canto.png',
}
*/

type Chains = Record<string, string>

const chains: Chains = { canto: '7700' }
